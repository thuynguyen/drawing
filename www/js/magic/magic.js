(function() {
  ...
  magic.loadCanvas = function(canvasId) {
    ...
    //canvas = document.getElementById(canvasId)
    bg = new Image()
    bg.src = "img/magic/sample_doodle.png"
  }
  ...
  magic.loadBg = function() {
    // fabric.Image.fromURL("img/magic/sample_doodle1.png", function(img) {
  ...
  magic.startRecordInWorker = function(src, direction) {
    worker = new Worker('img/magic/magicWorker.js')
    progress = 0
