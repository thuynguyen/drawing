;jQuery(document).ready(function($) {
  ...
  $('#_addLeftAnimation').click(function() {magic.startRecordInWorker("img/magic/train.png", "Left")})
  $('#_addRightAnimation').click(function() {magic.startRecordInWorker("img/magic/train.png", "Right")})
  $('#_addBottomTopAnimation').click(function() {magic.startRecordInWorker("img/img/space_ship.png", "Top")})
  ...
  textMagic.init({canvasId: 'playground',
                ...
                background: 'img/magic/sample_doodle.png',
                text: 'Hello world'
  })
